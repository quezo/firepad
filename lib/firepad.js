...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    var disablePublishEditorChanges = this.getOption('disablePublishEditorChanges', false);;
    ...
    if (this.codeMirror_) {
      this.richTextCodeMirror_ = new RichTextCodeMirror(
        ...
        {
          cssPrefix: 'firepad-',
          disablePublishEditorChanges: disablePublishEditorChanges
        }
      );
      this.editorAdapter_ = new RichTextCodeMirrorAdapter(this.richTextCodeMirror_, disablePublishEditorChanges);
    } else {
